# -----------------------------------------------------------------------------
# DEPS file for pthread-win32 scaffold
# =========================================
# -----------------------------------------------------------------------------

# This file is used to manage the dependencies of the
# pthread-win32-scaffold scaffold repo.
...
deps = {
  ...
  # this
  # line
  'pthread-win32': 'https://github.com/GerHobbelt/pthread-win32.git@{pthread-win32_revision}',
  # keep
  # this
  # line
}
